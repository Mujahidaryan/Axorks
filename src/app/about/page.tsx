...
export default function AboutPage() {
  return (
    <div className="bg-[#F8F7F4]">
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 items-center">
            <div>
              ...
              <p className="mt-4 text-base leading-relaxed text-slate-600">
                We operate from our offices in Karachi and Islamabad with an in-house team of senior engineers and designers. When you work with Axorks, you work directly with the people building your product — no middlemen, no outsourcing.
              </p>
              <p className="mt-4 text-base leading-relaxed text-slate-600">
      ...
      ============================================================ */}
      <section className="border-b border-slate-200/80 bg-[#F8F7F4]">
        <div className="mx-auto max-w-6xl px-5 py-20 sm:px-8 sm:py-28">
          ...
          <div className="mt-10 grid grid-cols-1 gap-8 md:grid-cols-2">
            {/* Muhammad Mujahid */}
            <div className="flex flex-col justify-between rounded-[12px] border border-slate-200/90 bg-white p-8 sm:p-9 shadow-[0_4px_16px_-4px_rgba(15,23,42,0.04),0_1px_3px_0_rgba(15,23,42,0.02)] transition-all duration-300 hover:shadow-[0_20px_40px_-10px_rgba(15,23,42,0.08)] hover:-translate-y-1 hover:border-slate-300">
              <div>
                <div className="flex items-start gap-4">
                  <div className="h-16 w-16 shrink-0 overflow-hidden rounded-[12px] border border-slate-200 bg-white shadow-sm">
                    <img
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#0F172A]">{FOUNDER_NAME}</h3>
            ...
            <div className="flex flex-col justify-between rounded-[12px] border border-slate-200/90 bg-white p-8 sm:p-9 shadow-[0_4px_16px_-4px_rgba(15,23,42,0.04),0_1px_3px_0_rgba(15,23,42,0.02)] transition-all duration-300 hover:shadow-[0_20px_40px_-10px_rgba(15,23,42,0.08)] hover:-translate-y-1 hover:border-slate-300">
              <div>
                <div className="flex items-start gap-4">
                  <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-[12px] border border-slate-200 bg-slate-100 text-xl font-bold text-slate-800 shadow-sm">
                    FB
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-[#0F172A]">Farhana Bakht</h3>
                    <p className="text-sm font-semibold text-slate-700">
                      Co-Founder
                    </p>
                  </div>
      ...
      <section className="border-b border-slate-200/80 bg-white">
        <div className="mx-auto max-w-6xl px-5 py-20 sm:px-8 sm:py-28">
          ...
          <div className="mt-10 grid grid-cols-1 gap-5 sm:grid-cols-2">
            <div className="rounded-[12px] border border-slate-200/90 bg-[#F8F7F4] p-6 shadow-2xs">
              <h3 className="text-base font-semibold text-[#0F172A]">Custom Web Applications</h3>
            ...
            <div className="rounded-[12px] border border-slate-200/90 bg-[#F8F7F4] p-6 shadow-2xs">
              <h3 className="text-base font-semibold text-[#0F172A]">AI Automation</h3>
            ...
            <div className="rounded-[12px] border border-slate-200/90 bg-[#F8F7F4] p-6 shadow-2xs">
              <h3 className="text-base font-semibold text-[#0F172A]">Mobile Apps</h3>
            ...
            <div className="rounded-[12px] border border-slate-200/90 bg-[#F8F7F4] p-6 shadow-2xs">
              <h3 className="text-base font-semibold text-[#0F172A]">Ongoing Support &amp; Maintenance</h3>
