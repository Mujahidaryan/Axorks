...
export default function AboutPage() {
  return (
    <div className="bg-[#FAF9F6]">
      {/* ============================================================
          HEADER — 2-COLUMN WITH MONUMENTAL ARTWORK
      ============================================================ */}
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-5 py-20 sm:px-8 sm:py-28">
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-8">
            ...
            <div className="lg:col-span-5">
              <div className="relative overflow-hidden rounded-[16px] border border-white/15 bg-gradient-to-br from-[#121520] to-[#0A0C14] p-2 shadow-2xl">
                <div className="relative aspect-square w-full overflow-hidden rounded-[12px]">
                  <Image
                    src="/assets/illustrations/about_hero.png"
                    alt="Axorks Digital Architecture & Engineering Philosophy"
                    fill
                    priority
                    className="object-cover object-center scale-[1.03]"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#0A0C14]/80 via-transparent to-transparent" />
                  <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between text-xs text-white/90 bg-slate-950/70 backdrop-blur-md px-3.5 py-2 rounded-[8px] border border-white/10">
                    <span className="font-semibold">Axorks Pvt Limited</span>
                    <span className="text-emerald-400 font-medium">Verified SECP Entity</span>
                  </div>
                </div>
              </div>
            </div>
