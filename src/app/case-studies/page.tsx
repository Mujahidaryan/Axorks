...
export const metadata: Metadata = {
  title: 'Shipped Case Studies | Axorks Software Studio',
  description:
    'Exploration of 6 live shipped production systems, including FWO grid-connected logistics and government-grade public sector platforms.',
};
  ...
  const projects: ProjectData[] = [
    {
      ...
      description:
        'National-scale agricultural supply chain tracking platform connected to FWO grid telemetry — monitoring cold chain compliance, thermal sensor logs, export compliance, and predictive logistics delay analytics across 28 export countries.',
      problem:
      ...
      built:
        'Developed high-throughput telemetry dashboard integrated with FWO grid telemetry, live geospatial mapping, and automated export compliance validation.',
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="border-b border-obsidian-border pb-6">
          <div className="inline-flex items-center gap-2 rounded border border-gold/40 bg-gold/10 px-3.5 py-1.5 font-mono text-xs font-semibold text-gold mb-3">
            ...
            <span>FWO Grid Telemetry & Government-Grade Systems</span>
          </div>
