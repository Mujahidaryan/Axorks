      ...
      <section className="relative min-h-[520px] lg:min-h-[580px] w-full overflow-hidden bg-[#0B0F19] text-[#F8FAFC] flex items-center border-b border-white/[0.08]">
        ...
        <div aria-hidden="true" className="pointer-events-none absolute inset-0 select-none overflow-hidden z-0">
          <video
            ...
            className="absolute inset-0 h-full w-full object-cover object-[15%_center] sm:object-[10%_center] lg:object-[5%_center] scale-[1.35] origin-left opacity-90 lg:-translate-x-8"
          >
            <source src="/assets/hero_motion.mp4" type="video/mp4" />
          </video>

          {/* Optical Gradient Scrim — Ensures 100% text dominance while core glows heavily on the left */}
          <div className="absolute inset-0 bg-gradient-to-r from-[#0B0F19]/95 via-[#0B0F19]/80 to-transparent lg:via-[#0B0F19]/70" />
