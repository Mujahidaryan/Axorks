...
export default function HomePage() {
  return (
    <div>
      {/* ============================================================
          HERO — 100% FULL-BLEED CINEMATIC HERO_MOTION (ZERO SEAMS)
      ...
      <section className="relative min-h-[760px] lg:min-h-[840px] w-full overflow-hidden bg-[#0B0F19] text-[#F8FAFC] flex items-center">
        ...
        <div className="relative z-10 mx-auto max-w-6xl w-full px-5 py-28 sm:px-8 sm:py-36 lg:py-40">
          <div className="max-w-2xl lg:max-w-[620px]">
            ...
            <h1 className="text-4xl font-semibold leading-[1.12] tracking-tight text-[#F8FAFC] sm:text-5xl lg:text-6xl drop-shadow-sm">
      ...
      ============================================================ */}
      <section className="relative border-t border-white/[0.08] bg-[#0B0F19] text-[#F8FAFC] py-20 sm:py-28">
        <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden select-none">
          <div className="absolute top-1/2 left-1/4 h-96 w-96 rounded-full bg-slate-800/20 blur-3xl" />
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-5 sm:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
            ...
            <div className="group relative flex flex-col justify-between overflow-hidden rounded-[16px] border border-slate-700/50 bg-gradient-to-br from-[#111827] via-[#161F33] to-[#0E1524] p-8 sm:p-10 shadow-[0_8px_32px_rgba(0,0,0,0.5)] transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_24px_48px_rgba(0,0,0,0.7)] text-[#F8FAFC]">
              ...
              <div className="relative z-10">
                <div className="mb-5 inline-flex h-11 w-11 items-center justify-center rounded-[10px] bg-white/10 backdrop-blur-md border border-white/15 text-slate-200 shadow-sm transition-transform duration-300 group-hover:scale-105">
                  <Layers className="h-5 w-5" />
                </div>
                <h3 className="text-2xl font-bold tracking-tight text-[#F8FAFC] transition-colors">
                ...
                <div className="mt-6 flex flex-wrap gap-2">
                  <span className="inline-flex items-center rounded-md px-2.5 py-1 text-xs font-medium border border-slate-600/50 bg-slate-800/40 text-slate-200 backdrop-blur-xs">
                    Client Portals
                  </span>
                  <span className="inline-flex items-center rounded-md px-2.5 py-1 text-xs font-medium border border-slate-600/50 bg-slate-800/40 text-slate-200 backdrop-blur-xs">
                    Internal Dashboards
            ...
            <div className="group relative flex flex-col justify-between overflow-hidden rounded-[16px] border border-slate-700/50 bg-gradient-to-br from-[#111827] via-[#161F33] to-[#0E1524] p-8 sm:p-10 shadow-[0_8px_32px_rgba(0,0,0,0.5)] transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_24px_48px_rgba(0,0,0,0.7)] text-[#F8FAFC]">
              ...
              <div className="relative z-10">
                ...
                <div className="mt-6 flex flex-wrap gap-2">
                  <span className="inline-flex items-center rounded-md px-2.5 py-1 text-xs font-medium border border-slate-600/50 bg-slate-800/40 text-[#DFBD6C] backdrop-blur-xs">
                    iOS &amp; Android Apps
                  </span>
                  <span className="inline-flex items-center rounded-md px-2.5 py-1 text-xs font-medium border border-slate-600/50 bg-slate-800/40 text-[#DFBD6C] backdrop-blur-xs">
                    Offline Data Sync
          ...
          {/* Pricing Banner */}
          <div className="mt-12 rounded-[14px] border border-amber-400/30 bg-gradient-to-r from-[#171A24] via-[#212433] to-[#171A24] p-8 shadow-lg flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-[#F8FAFC]">
      ...
      ============================================================ */}
      <section className="border-t border-slate-200/80 bg-gradient-to-b from-[#F8F7F4] via-[#F2F0EB] to-[#F8F7F4]">
        <div className="mx-auto max-w-6xl px-5 py-20 sm:px-8 sm:py-28">
          <div className="mb-14 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
            ...
            <Link
              href="/case-studies"
              className="group inline-flex shrink-0 items-center gap-1.5 text-sm font-semibold text-[#0F172A] transition-colors hover:text-[#C9A227]"
            >
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            {/* AgroTrace */}
            <article className="overflow-hidden rounded-[14px] border border-slate-200/90 bg-white shadow-[0_4px_18px_-4px_rgba(15,23,42,0.06),0_1px_3px_0_rgba(15,23,42,0.02)] transition-all duration-300 hover:-translate-y-1.5 hover:border-slate-300 hover:shadow-[0_24px_48px_-12px_rgba(15,23,42,0.12),0_8px_16px_-4px_rgba(15,23,42,0.04)] flex flex-col justify-between">
              <div>
                ...
                <div className="p-7">
                  <span className="inline-flex items-center rounded-full bg-slate-100 px-2.5 py-0.5 text-xs font-semibold text-slate-800 ring-1 ring-slate-200">
                    Agriculture &amp; Telemetry
                  </span>
                  <h3 className="mt-3 text-xl font-semibold text-[#0F172A]">AgroTrace</h3>
                  <p className="mt-3 text-sm leading-relaxed text-slate-600">
                    Supply-chain tracking platform with live thermal monitoring, automated alerts, and export-compliance validation.
                  </p>
                  <div className="mt-5 rounded-[8px] bg-slate-50 border border-slate-100 p-3.5 shadow-2xs">
                    <p className="text-xs font-medium text-slate-900 leading-relaxed">
                      <strong className="font-semibold text-[#0F172A]">Result:</strong> Gave logistics teams real-time visibility into temperature problems, shipment delays, and export compliance.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <article className="overflow-hidden rounded-[14px] border border-slate-200/90 bg-white shadow-[0_4px_18px_-4px_rgba(15,23,42,0.06),0_1px_3px_0_rgba(15,23,42,0.02)] transition-all duration-300 hover:-translate-y-1.5 hover:border-slate-300 hover:shadow-[0_24px_48px_-12px_rgba(15,23,42,0.12),0_8px_16px_-4px_rgba(15,23,42,0.04)] flex flex-col justify-between">
              <div>
                ...
                <div className="p-7">
                  ...
                  <h3 className="mt-3 text-xl font-semibold text-[#0F172A]">AI Decision System</h3>
                  <p className="mt-3 text-sm leading-relaxed text-slate-600">
                  ...
                  <div className="mt-5 rounded-[8px] bg-slate-50 border border-slate-100 p-3.5 shadow-2xs">
                    <p className="text-xs font-medium text-slate-900 leading-relaxed">
                      <strong className="font-semibold text-[#0F172A]">Result:</strong> Helped teams identify changing conditions in real time and choose strategies based on the current situation.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <article className="overflow-hidden rounded-[14px] border border-slate-200/90 bg-white shadow-[0_4px_18px_-4px_rgba(15,23,42,0.06),0_1px_3px_0_rgba(15,23,42,0.02)] transition-all duration-300 hover:-translate-y-1.5 hover:border-slate-300 hover:shadow-[0_24px_48px_-12px_rgba(15,23,42,0.12),0_8px_16px_-4px_rgba(15,23,42,0.04)] flex flex-col justify-between">
              <div>
                ...
                <div className="p-7">
                  ...
                  <h3 className="mt-3 text-xl font-semibold text-[#0F172A]">MediVerse</h3>
                  <p className="mt-3 text-sm leading-relaxed text-slate-600">
                  ...
                  <div className="mt-5 rounded-[8px] bg-slate-50 border border-slate-100 p-3.5 shadow-2xs">
                    <p className="text-xs font-medium text-slate-900 leading-relaxed">
                      <strong className="font-semibold text-[#0F172A]">Result:</strong> Brought patient, doctor, and assistant workflows into one system, making appointments and administration easier to manage.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="relative border-t border-white/[0.08] bg-gradient-to-b from-[#0B0F19] via-[#111827] to-[#0B0F19] text-[#F8FAFC]">
        <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden select-none">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[500px] w-[800px] rounded-full bg-[#C9A227]/5 blur-3xl opacity-50" />
        </div>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-5 py-20 sm:px-8 sm:py-28">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {/* Step 1 */}
            <div className="group relative rounded-[12px] border border-white/[0.08] bg-gradient-to-b from-[#141B2D] to-[#0F1424] p-8 shadow-md transition-all duration-300 hover:-translate-y-1 hover:border-[#C9A227]/40 hover:shadow-[0_12px_32px_rgba(201,162,39,0.12)] flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between">
                  <span className="text-2xl font-bold text-[#DFBD6C] font-mono tracking-tight drop-shadow-[0_0_12px_rgba(201,162,39,0.3)]">01</span>
                  <span className="text-[11px] font-medium text-slate-400 bg-white/5 px-2 py-0.5 rounded-full">1–2 Days</span>
                </div>
                <h3 className="mt-4 text-base font-semibold text-[#F8FAFC]">Discovery Call</h3>
            ...
            <div className="group relative rounded-[12px] border border-white/[0.08] bg-gradient-to-b from-[#141B2D] to-[#0F1424] p-8 shadow-md transition-all duration-300 hover:-translate-y-1 hover:border-[#C9A227]/40 hover:shadow-[0_12px_32px_rgba(201,162,39,0.12)] flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between">
                  <span className="text-2xl font-bold text-[#DFBD6C] font-mono tracking-tight drop-shadow-[0_0_12px_rgba(201,162,39,0.3)]">02</span>
                  <span className="text-[11px] font-medium text-slate-400 bg-white/5 px-2 py-0.5 rounded-full">48 Hours</span>
                </div>
                <h3 className="mt-4 text-base font-semibold text-[#F8FAFC]">Proposal</h3>
                <p className="mt-2.5 text-sm leading-relaxed text-slate-300">
            ...
            <div className="group relative rounded-[12px] border border-white/[0.08] bg-gradient-to-b from-[#141B2D] to-[#0F1424] p-8 shadow-md transition-all duration-300 hover:-translate-y-1 hover:border-[#C9A227]/40 hover:shadow-[0_12px_32px_rgba(201,162,39,0.12)] flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between">
                  <span className="text-2xl font-bold text-[#DFBD6C] font-mono tracking-tight drop-shadow-[0_0_12px_rgba(201,162,39,0.3)]">03</span>
                  <span className="text-[11px] font-medium text-slate-400 bg-white/5 px-2 py-0.5 rounded-full">2–6 Weeks</span>
                </div>
                <h3 className="mt-4 text-base font-semibold text-[#F8FAFC]">Build &amp; Launch</h3>
                <p className="mt-2.5 text-sm leading-relaxed text-slate-300">
            ...
            <div className="group relative rounded-[12px] border border-white/[0.08] bg-gradient-to-b from-[#141B2D] to-[#0F1424] p-8 shadow-md transition-all duration-300 hover:-translate-y-1 hover:border-[#C9A227]/40 hover:shadow-[0_12px_32px_rgba(201,162,39,0.12)] flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between">
                  <span className="text-2xl font-bold text-[#DFBD6C] font-mono tracking-tight drop-shadow-[0_0_12px_rgba(201,162,39,0.3)]">04</span>
                  <span className="text-[11px] font-medium text-slate-400 bg-white/5 px-2 py-0.5 rounded-full">Continuous</span>
                </div>
                <h3 className="mt-4 text-base font-semibold text-[#F8FAFC]">Ongoing Support</h3>
                <p className="mt-2.5 text-sm leading-relaxed text-slate-300">
      ...
      <section className="border-t border-slate-200/80 bg-gradient-to-b from-[#F8F7F4] via-[#F2F0EB] to-[#F8F7F4]">
        <div className="mx-auto max-w-6xl px-5 py-20 sm:px-8 sm:py-28">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { title: 'Fixed-price proposals', desc: 'You know the cost before we start. No surprises.', border: 'border-slate-200/90 hover:border-slate-300', bg: 'from-white to-slate-50' },
              { title: 'Direct access to engineers', desc: 'You work directly with the people building your software. No middlemen.', border: 'border-slate-200/90 hover:border-slate-300', bg: 'from-white to-slate-50' },
              { title: 'Real office, real team', desc: 'We operate from real offices in Karachi and Islamabad with a dedicated in-house team.', border: 'border-slate-200/90 hover:border-slate-300', bg: 'from-white to-slate-50' },
              { title: 'Payment on milestones', desc: 'Payment is structured around clear project milestones. You pay for progress you can see.', border: 'border-slate-200/90 hover:border-slate-300', bg: 'from-white to-slate-50' },
              { title: 'UK, US & EU time zones', desc: 'We overlap with your working hours for meetings and updates.', border: 'border-slate-200/90 hover:border-slate-300', bg: 'from-white to-slate-50' },
              { title: '24-hour response guarantee', desc: 'Every message gets a response within 24 hours.', border: 'border-slate-200/90 hover:border-slate-300', bg: 'from-white to-slate-50' },
            ].map((item) => (
              <div
                key={item.title}
              ...
              >
                <div className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-[8px] bg-white text-slate-800 shadow-sm ring-1 ring-slate-200 transition-transform duration-300 group-hover:scale-110">
            ...
            <div>
              ...
              <ul className="mt-8 space-y-4">
                <li className="flex items-center gap-3 text-sm text-slate-200">
                  <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-slate-800 text-[#DFBD6C] ring-1 ring-slate-700">
