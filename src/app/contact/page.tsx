        ...
        <div className="mx-auto max-w-6xl px-5 sm:px-8">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              {/* Trust Points */}
              <div className="space-y-4 rounded-[12px] border border-slate-200/85 bg-white p-7 shadow-[0_2px_10px_-2px_rgba(15,23,42,0.04),0_1px_3px_0_rgba(15,23,42,0.02)]">
                <div className="flex items-center gap-3 text-sm font-medium text-slate-800">
                  <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-teal-50 text-[#0D9488] ring-1 ring-teal-200/70">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <a
                    ...
                    className="flex items-center gap-3 rounded-[12px] border border-slate-200/85 bg-white p-4 text-sm font-semibold text-slate-900 shadow-sm transition-all hover:border-slate-300 hover:shadow hover:-translate-y-0.5"
                  >
